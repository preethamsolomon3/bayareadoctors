...
class ConsultationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consultation" do
    assert_difference('Consultation.count') do
      post consultations_url, params: { consultation: { end_time: @consultation.end_time, start_time: @consultation.start_time } }
    end
  ...
  test "should update consultation" do
    patch consultation_url(@consultation), params: { consultation: { end_time: @consultation.end_time, start_time: @consultation.start_time } }
